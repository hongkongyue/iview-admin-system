...
util.formatOrderStatusNew = function (value) {
  let orderStatus = '未知状态';
  switch (value) {
    case '0':
      orderStatus = '- -';
...
//退款状态
util.returnOrderStatus = function (value) {
  let orderStatus = '未知状态';
  switch (value) {
    case 200:
      orderStatus = '已申请';
...
//退货审核状态 || 退款审核状态
util.returnAuditStatus = function (value) {
  let orderStatus = '未知状态';
  switch (value) {
    case 200:
      orderStatus = '待审核';
...
util.getDingtalkAppId = function () {
  let appList = {
    "eop.quanshangtech.com": "dingoapunpg2qutdyoleh2",
    "eop.eptison.com": "dingoam3zfurp3qybw3kko",
    "eopsit.eptison.com": "dingoapyyfil91dtipsx04",
    "eopuat.eptison.com": "dingoacjhvxhwtjfkms0yy",
    "localhost": "dingoauuxtdxsunkobfjkr",
    "127.0.0.1": "dingoa1yvfeb526f60vmo4"
  }
