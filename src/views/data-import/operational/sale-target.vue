<template>
    <div class="background-color-white exhibition" id="sale-target">
                    ...
                    <Row>
                        ...
                        <!-- <Col>
                            <Form-item label="销售渠道：" prop="platfromCode">
                                <Select :disabled='modal_title != "新增销售指标"' v-model="ModalForm.platfromId" @on-change='changePlatfrom' style="width:150px" size="small">
                        ...
                        <Col>
                            <Form-item label="品牌：" prop="brandId">
                                <Select :disabled='modal_title != "新增销售指标"'  v-model.number="ModalForm.brandId" style="width:150px" size="small" @on-change='changeBrand'>
                                    <Option v-for="item in brandList" :value="item.id" :key="item.id">{{ item.brands }}
                                    </Option>
                                </Select>
                            </Form-item>
                        ...
                        <Col>
                            <Form-item label="年份：" prop="years" >
                                <Input :disabled='modal_title != "新增销售指标"'  size="small"  style="width:150px" v-model="ModalForm.years" ></Input>
                            </Form-item>
                        </Col>
                        <Col>
                            <Form-item label="月份：" prop="month" >
                                <Input :disabled='modal_title != "新增销售指标"'  size="small"  style="width:150px" v-model="ModalForm.month" ></Input>
                            </Form-item>
                        </Col>
                        <Col>
                            <Form-item label="总销售收入：" prop="saleAmount">
                                <Input v-model.number="ModalForm.saleAmount" size="small"  placeholder="请输入总销售收入" style="width:150px"></Input>
                            </Form-item>
                        </Col>
                        <Col>
                            <Form-item label="季节占比(%)：" prop="seasonRate">
                                <Input v-model.number="ModalForm.seasonRate" size="small"  placeholder="请输入季节占比" style="width:150px"></Input>
                            </Form-item>
                        </Col>
                        <Col>
                            <Form-item label="毛利率(%)：" prop="grossIncomeRate">
                                <Input v-model.number="ModalForm.grossIncomeRate" size="small"  placeholder="请输入季节占比" style="width:150px"></Input>
                            </Form-item>
                        </Col>
                    </Row>
                </Form>
          ...
          <Modal
                ...
                <div>
                    <Upload
                        ...
                        type="drag"
                        action="/eop/eom/import_sale_target"
...
<script>
    ...
    function ModalForm(){
        return {
            ...
            month:'',               //	月份	        number	
            season:'',              //季节
            saleAmount:'',        //	总销售收入	 number	
            seasonRate:'',        //	季节占比	    number	
            remark:'',              //	备注	        string
            grossIncomeRate:'',        //  毛利率
            saleIncome:'',        //  收入
            saleCost:'',        //  成本
    ...
    export default {
                        ...
                        render: (h, params) => {
                            return h('div', [
                                h('Button', {
                                    ...
                                    on: {
                                        click: () => {
                                            this.openModal('编辑销售指标',params.row);
                                        }
                                    }
                                }, '编辑')
                            ]);
        ...
        methods: {
            ...
            downTemplate() {
                window.location = ('/excel/季节销售指标导入模板.xlsx');
            },
            importData() {
            ...
            getData() {
                ...
                this.request('get_sale_target_list', {
                    data: data
                }, true).then((res) => {
                    let serialNoBegain = this.pageSize * (this.page - 1);
                    res.data.saleTargetList.map(x => {
                        serialNoBegain++;
                        x.serialNo = serialNoBegain;
                    })
                    this.total = res.data.count;
                    this.list = res.data.saleTargetList
                    console.log(res)
                })
            },
            SizeChange(val) {
            ...
            submit(){
                ...
                let url = '';
                if(this.modal_title == '新增销售指标'){
                    data.createUser = this.userInfo.userAccount;
                    url = 'add_sale_target';
                }else if(this.modal_title == '编辑销售指标'){
                    url='edit_sale_target';
