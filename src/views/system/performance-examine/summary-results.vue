                    ...
                    },
                     {
                        ...
                        children:[
                                    ...
                                    render: (h, params) => {
                                        if(this.list[params.index].EMPLOYEE_TYPE=='中层'){
                                          return h('span', {
                                                    }, this.list[params.index].协作评委?this.list[params.index].协作评委:'未参与评分'); 
                                       }else{
                                           return h('span', {
                                                    }, '');  
                                       }   
                            ...
                            render:(h,params)=>{
                                 if(this.list[params.index].EMPLOYEE_TYPE=='中层'){
                                          return h('span', {
                                                    }, this.list[params.index].财务管理中心负责人?this.list[params.index].财务管理中心负责人:'0'); 
                                       }else{
                                           return h('span', {
                                                    }, '');  
                                       }   
                                // return h('span',{},
                                //     this.initlist[params.index].财务管理中心负责人?this.initlist[params.index].财务管理中心负责人 :'0'
                                // )
                            }
                        },
                                        // {
