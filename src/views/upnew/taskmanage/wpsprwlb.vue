    ...
    export default {
        ...
        methods:{
            ...
            getData(){
                ...
                data.taskStatus = this.taskStatus
                 this.request('getTaskOutdoorVideoList', {data}, false).then((res) => {
                    if(res.code==1){
                        if(this.taskStatus == '100'){
                            this.List = res.data.OutdoorVideoList
                            this.total = res.data.count
                        }else if(this.taskStatus == '400'){
                            this.list1 = res.data.OutdoorVideoList
                            this.total1 = res.data.count
                        }else if(this.taskStatus == '900'){
                            this.list2 = res.data.OutdoorVideoList
